...
export const TRAININGS = [
  {
    ...
    video: 'https://drive.google.com/file/d/15836VVZEFftNMuMVfOb9yeq-o60QDPjj/preview', materials: [], pass: 70,
    questions: [
  ...
  },
  {
    ...
    video: '', materials: [{ nm: 'Apostila — Pesquisa de Satisfação (PDF)', url: 'assets/treinamentos/pesquisa-satisfacao.pdf' }], pass: 70,
    questions: [
